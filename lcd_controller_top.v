module lcd_controller_top (
   ...
   integer i;
    always @(*) begin
			 ...
			 // --- COMANDO DE RETORNAR AO INÍCIO DA LINHA 1 (Agora é índice 1) ---
			 message[1] = {1'b0, 8'h80};

			 // --- LINHA 1: Nome completo (Índices deslocados em +1) ---
			 ...
			 // Endereço [XXXX] (Índices deslocados em +1) 
			 ...
			 // --- COMANDO DE PULAR LINHA (Agora no índice 18) ---
			 message[18] = {1'b0, 8'hC0}; 

			 // --- LINHA 2: Sinal e valor (Índices deslocados em +1) ---
